...
public class RecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new MedicineAdapter(MedicinesList,RecyclerActivity.this);
        ...
        if(name.size()!=0 && price.size()!=0){
            ...
            {
                String random="abc";
                Medicine medicine = new Medicine(name.get(i),String.valueOf(price.get(i)),random,"abd");
        ...
        db.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot childSnap:dataSnapshot.getChildren()){
                    ...
                    String random2="abc";
                    Medicine medicine1= new Medicine(name,"Rs:"+String.valueOf(price),random2,"abcd");
